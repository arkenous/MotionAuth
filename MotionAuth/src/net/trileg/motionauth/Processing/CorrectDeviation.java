...
public class CorrectDeviation {
   ...
   */
  public double[][][][] correctDeviation(double[][][] distance, double[][][] linearDistance, double[][][] angle, Enum.MODE mode, Enum.TARGET target) {
    LogUtil.log(Log.INFO);

    // ずらしたデータを格納する配列
    double[][][][] newData = new double[3][Enum.NUM_TIME][Enum.NUM_AXIS][distance[0][0].length];

...
public class Fourier {
	...
	public double[][] LowpassFilter(double[][] data, String dataName) {
		...
		mManageData.writeDoubleTwoArrayData("ResultFFT", "rFFT" + dataName, InputName.name, real);
		mManageData.writeDoubleTwoArrayData("ResultFFT", "iFFT" + dataName, InputName.name, imaginary);
		...
		mManageData.writeDoubleTwoArrayData("ResultFFT", "powerFFT" + dataName, InputName.name, power);
		...
		mManageData.writeDoubleTwoArrayData("AfterFFT", dataName, InputName.name, data);

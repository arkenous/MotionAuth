...
public class AuthMotion extends Activity implements SensorEventListener, Runnable {
	...
	private class TimeHandler extends Handler {
		...
		private final WeakReference<AuthMotion> refAuthMotion;

		public TimeHandler(AuthMotion authMotion) {
			refAuthMotion = new WeakReference<>(authMotion);
		}
		...
		public void dispatchMessage(Message msg) {
			...
			AuthMotion activity = refAuthMotion.get();
			if (activity == null) {
				return;
			}
	...
	private class ResultHandler extends Handler {
		...
		public ResultHandler(AuthMotion authMotion) {
			refAuthMotion = new WeakReference<>(authMotion);
		}
